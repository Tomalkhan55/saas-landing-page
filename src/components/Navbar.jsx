...
export default function Navbar() {
  ...
  const handleScroll = (e, href) => {
    ...
    // Menu close হতে একটু সময় দাও, তারপর scroll করো
    setTimeout(() => {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "glass border-b border-dark-border py-3" : "py-5"
        }`}
    >
